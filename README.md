<div style="background-color:#454545; padding: 15px; color: #fff;  font-size: 1.25em; margin-bottom: 20px">BIO 🤖</div>
...
<div style="background-color:#454545; padding: 15px; color: #fff;  font-size: 1.25em;margin-top: 30px">Projects  🚀</div>
...
<div style="background-color:#454545; padding: 15px; color: #fff;  font-size: 1.25em;margin-top: 30px"> Programming Skills ⚔️</div>
...
<div style="background-color:#454545; padding: 15px; color: #fff;  font-size: 1.25em;margin-top: 30px"> Design Skills 🎨</div>
